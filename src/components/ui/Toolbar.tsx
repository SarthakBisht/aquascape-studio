...
export function Toolbar({ onScreenshot }: { onScreenshot: () => void }) {
  ...
  return (
    <header className="pointer-events-auto flex items-center gap-3 rounded-xl border border-white/10 bg-slate-900/70 px-3 py-2 text-slate-100 shadow-xl backdrop-blur-md">
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        <label className="flex items-center gap-1 text-[11px] text-slate-300">
          ...
          <select
            ...
            className="rounded-md border border-white/10 bg-white/5 px-1.5 py-1 text-xs capitalize"
          >
            {QUALITIES.map((q) => (
